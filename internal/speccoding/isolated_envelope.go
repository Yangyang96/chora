...
func (e ResourceEnvelope) WithIsolatedExecution(id IsolatedExecutionIdentity) (ResourceEnvelope, error) {
	...
	e.template.Candidate.Model = ModelCandidate{Provider: "deepseek", ModelID: "deepseek-v4-pro", IdentityStatus: "observed_at_runtime", AuthenticationType: "task_scoped_api_key"}
...
func validateIsolatedCandidate(c CandidateCombination) error {
	if c.Runtime.Package != "@earendil-works/pi-coding-agent" || c.Runtime.Version != "0.85.1" || c.Runtime.Config.Path != "public-pi-image" || !validLowerHex(c.Runtime.Config.SHA256, 64) ||
		...
		c.Model.Provider != "deepseek" || c.Model.ModelID != "deepseek-v4-pro" || c.Model.IdentityStatus != "observed_at_runtime" || c.Model.AuthenticationType != "task_scoped_api_key" || c.Model.Endpoint != "" || c.Model.ModelDigest != "" {
