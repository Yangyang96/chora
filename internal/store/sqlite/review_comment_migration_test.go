...
func TestV35ReviewCommentMigrationPreservesReview(t *testing.T) {
	...
	rollback := `DROP TABLE delegation_planning_intents; DROP TABLE delegation_proposal_sources; DROP TABLE task_delegation_children; DROP TABLE task_delegations; DROP TABLE task_execution_settings; DROP TABLE project_execution_settings;
