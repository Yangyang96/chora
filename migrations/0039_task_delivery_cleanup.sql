CREATE TABLE task_delivery_operations_next (
 operation_id TEXT PRIMARY KEY,
 task_id TEXT NOT NULL REFERENCES tasks(id) ON DELETE RESTRICT,
 run_id TEXT NOT NULL REFERENCES runs(id) ON DELETE RESTRICT,
 repo_id TEXT NOT NULL REFERENCES repositories(repo_id) ON DELETE RESTRICT,
 kind TEXT NOT NULL CHECK(kind IN ('commit','push','pr','merge','cleanup')),
...
INSERT INTO task_delivery_operations_next SELECT * FROM task_delivery_operations;
DROP TABLE task_delivery_operations;
ALTER TABLE task_delivery_operations_next RENAME TO task_delivery_operations;
